  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav">
        ...
        <li><a href="controller.php?acao=cliente">Cliente</a></li>
        <li><a href="controller.php?acao=modalidade">Modalidade</a></li>
		<li><a href="controller.php?acao=horario">Horário</a></li>
		<li><a href="controller.php?acao=usuario">Usuário</a></li>
